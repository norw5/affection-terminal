...
export function KBDoc() {
  const { doc: slug } = useParams({ from: "/knowledge-base/$doc" });
  ...
  if (!doc) {
    return (
      <div className="mx-auto max-w-3xl">
        ...
        <Link to="/knowledge-base" className="text-info hover:underline">
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-3">
      <div className="flex items-center gap-2 text-xs text-text-faint">
        <Link to="/knowledge-base" className="hover:text-text">
          knowledge-base
        </Link>
        <span>/</span>
